...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="start">
        ...
        <node id="n291">
            <attr name="layout">
                <string>166 107 46 21</string>
            </attr>
        </node>
        <node id="n297">
            <attr name="layout">
                <string>298 143 46 21</string>
            </attr>
        </node>
        <node id="n293">
            <attr name="layout">
                <string>299 69 46 21</string>
            </attr>
        </node>
        <node id="n295">
            <attr name="layout">
                <string>88 219 47 21</string>
            </attr>
        </node>
        <node id="n292">
            <attr name="layout">
                <string>165 165 47 21</string>
            </attr>
        </node>
        <node id="n296">
            <attr name="layout">
                <string>298 202 47 21</string>
            </attr>
        </node>
        <node id="n294">
            <attr name="layout">
                <string>193 216 46 21</string>
            </attr>
        </node>
