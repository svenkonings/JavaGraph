...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="graph" role="graph" edgeids="false" edgemode="directed">
        ...
        <edge from="n40" to="n20">
            <attr name="label">
                <string>operator</string>
            </attr>
        </edge>
        <edge from="n27" to="n24">
            <attr name="label">
                <string>left</string>
            </attr>
        </edge>
        ...
        <edge from="n14" to="n48">
            <attr name="label">
                <string>index</string>
            </attr>
        </edge>
        <edge from="n43" to="n12">
            <attr name="label">
                <string>name</string>
            </attr>
        </edge>
        ...
        <edge from="n2" to="n2">
            <attr name="label">
                <string>string:"ForStatement"</string>
            </attr>
        </edge>
        ...
        <edge from="n47" to="n48">
            <attr name="label">
                <string>incrementLastIndex</string>
            </attr>
        </edge>
        ...
        <edge from="n40" to="n48">
            <attr name="label">
                <string>index</string>
            </attr>
        </edge>
        <edge from="n47" to="n36">
            <attr name="label">
                <string>increment</string>
            </attr>
        </edge>
        ...
        <edge from="n47" to="n48">
            <attr name="label">
                <string>initializationLastIndex</string>
            </attr>
        </edge>
