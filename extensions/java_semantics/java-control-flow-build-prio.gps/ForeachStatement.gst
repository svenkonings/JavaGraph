...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="graph" role="graph" edgeids="false" edgemode="directed">
        ...
        <edge from="n2" to="n2">
            <attr name="label">
                <string>string:"ForeachStatement"</string>
            </attr>
        </edge>
        ...
        <edge from="n36" to="n26">
            <attr name="label">
                <string>collection</string>
            </attr>
        </edge>
        <edge from="n36" to="n24">
            <attr name="label">
                <string>elementVar</string>
            </attr>
        </edge>
        <edge from="n37" to="n9">
            <attr name="label">
        ...
        <edge from="n36" to="n36">
            <attr name="label">
                <string>type:ForeachStmt</string>
            </attr>
        </edge>
