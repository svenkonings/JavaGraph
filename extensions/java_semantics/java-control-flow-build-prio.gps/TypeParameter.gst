...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="graph" role="graph" edgeids="false" edgemode="directed">
        ...
        <edge from="n11" to="n11">
            <attr name="label">
                <string>type:TypeParameter</string>
            </attr>
        </edge>
        ...
        <edge from="n33" to="n13">
            <attr name="label">
                <string>returnType</string>
            </attr>
        </edge>
        <edge from="n28" to="n22">
            <attr name="label">
                <string>resolvedType</string>
            </attr>
        </edge>
        ...
        <edge from="n2" to="n2">
            <attr name="label">
                <string>string:"TypeParameter"</string>
            </attr>
        </edge>
        ...
        <edge from="n33" to="n12">
            <attr name="label">
                <string>typeParameterLastIndex</string>
            </attr>
        </edge>
