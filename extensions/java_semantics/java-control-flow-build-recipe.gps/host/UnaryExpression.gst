...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="host.UnaryExpression">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n12">
        ...
        <node id="n15">
            <attr name="layout">
                <string>742 382 116 34</string>
            </attr>
        </node>
        <node id="n16">
            <attr name="layout">
                <string>713 240 173 85</string>
            </attr>
        </node>
        <node id="n4">
            <attr name="layout">
                <string>22 29 19 19</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
                <string>592 382 89 51</string>
            </attr>
        </node>
        <node id="n14">
            <attr name="layout">
                <string>34 17 19 19</string>
            </attr>
        </node>
        <node id="n19">
            <attr name="layout">
                <string>381 116 173 68</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>56 25 19 19</string>
            </attr>
        </node>
        <node id="n21">
            <attr name="layout">
                <string>416 8 104 51</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
                <string>580 490 113 51</string>
            </attr>
        </node>
        <node id="n8">
            <attr name="layout">
                <string>382 382 129 51</string>
            </attr>
        </node>
        <node id="n18">
            <attr name="layout">
                <string>21 48 19 19</string>
            </attr>
        </node>
        <node id="n13">
            <attr name="layout">
                <string>496 240 84 85</string>
            </attr>
        </node>
        <node id="n0">
            <attr name="layout">
        ...
        <edge from="n17" to="n17">
            <attr name="label">
                <string>string:&quot;UnaryExpression&quot;</string>
            </attr>
        </edge>
        <edge from="n5" to="n5">
            <attr name="label">
