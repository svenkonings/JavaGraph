...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="host.AND_AND_Expression">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n23">
            <attr name="layout">
                <string>474 8 104 51</string>
            </attr>
        </node>
        <node id="n19">
            <attr name="layout">
        ...
        <node id="n20">
            <attr name="layout">
                <string>423 115 207 68</string>
            </attr>
        </node>
        <node id="n18">
            <attr name="layout">
                <string>16 17 19 19</string>
            </attr>
        </node>
        <node id="n7">
            <attr name="layout">
                <string>21 18 19 19</string>
            </attr>
        </node>
        <node id="n6">
            <attr name="layout">
        ...
        <node id="n21">
            <attr name="layout">
                <string>25 42 19 19</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>34 24 19 19</string>
            </attr>
        </node>
        <node id="n22">
            <attr name="layout">
                <string>39 19 19 19</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
                <string>591 487 113 51</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
                <string>294 380 79 51</string>
            </attr>
        </node>
        <node id="n14">
            <attr name="layout">
                <string>607 239 84 85</string>
            </attr>
        </node>
        <node id="n16">
            <attr name="layout">
                <string>841 380 116 34</string>
            </attr>
        </node>
        <node id="n8">
            <attr name="layout">
                <string>432 380 164 51</string>
            </attr>
        </node>
        <node id="n13">
            <attr name="layout">
        ...
        <node id="n11">
            <attr name="layout">
                <string>784 487 83 51</string>
            </attr>
        </node>
        <node id="n4">
            <attr name="layout">
                <string>82 22 19 19</string>
            </attr>
        </node>
        <node id="n0">
            <attr name="layout">
                <string>50 380 164 51</string>
            </attr>
        </node>
        <node id="n17">
            <attr name="layout">
                <string>796 239 207 85</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
                <string>169 239 84 85</string>
            </attr>
        </node>
        <node id="n12">
            <attr name="layout">
                <string>676 380 106 51</string>
            </attr>
        </node>
        ...
        <edge from="n18" to="n18">
            <attr name="label">
                <string>string:&quot;AND_AND_Expression&quot;</string>
            </attr>
        </edge>
        <edge from="n7" to="n7">
            <attr name="label">
