...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="host.MethodDeclaration-Args-NoStmt">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n34">
            <attr name="layout">
                <string>110 8 104 51</string>
            </attr>
        </node>
        <node id="n33">
            <attr name="layout">
                <string>129 115 67 34</string>
            </attr>
        </node>
        <node id="n12">
            <attr name="layout">
                <string>203 313 73 51</string>
            </attr>
        </node>
        <node id="n21">
            <attr name="layout">
        ...
        <node id="n30">
            <attr name="layout">
                <string>87 205 151 51</string>
            </attr>
        </node>
        <node id="n0">
            <attr name="layout">
                <string>50 313 73 51</string>
            </attr>
        </node>
