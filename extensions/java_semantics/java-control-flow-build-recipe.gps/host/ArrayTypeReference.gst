...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="host.ArrayTypeReference">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n6">
        ...
        <node id="n19">
            <attr name="layout">
                <string>293 8 104 51</string>
            </attr>
        </node>
        <node id="n12">
            <attr name="layout">
                <string>485 382 99 68</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
                <string>15 29 19 19</string>
            </attr>
        </node>
        <node id="n2">
            <attr name="layout">
        ...
        <node id="n8">
            <attr name="layout">
                <string>429 506 212 68</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>50 224 194 85</string>
            </attr>
        </node>
        <node id="n18">
            <attr name="layout">
                <string>248 116 194 51</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
        ...
        <node id="n4">
            <attr name="layout">
                <string>39 25 19 19</string>
            </attr>
        </node>
        <node id="n14">
            <attr name="layout">
                <string>341 224 223 102</string>
            </attr>
        </node>
        <node id="n17">
            <attr name="layout">
                <string>33 29 19 19</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
                <string>265 382 139 51</string>
            </attr>
        </node>
        <node id="n13">
            <attr name="layout">
                <string>31 39 19 19</string>
            </attr>
        </node>
        <node id="n0">
            <attr name="layout">
                <string>89 366 116 34</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
                <string>47 48 19 19</string>
            </attr>
        </node>
        <node id="n16">
            <attr name="layout">
                <string>94 72 19 19</string>
            </attr>
        </node>
        <edge from="n6" to="n6">
            <attr name="label">
        ...
        <edge from="n2" to="n2">
            <attr name="label">
                <string>string:&quot;ArrayTypeReference&quot;</string>
            </attr>
        </edge>
        <edge from="n8" to="n8">
            <attr name="label">
