...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="host.PostfixExpression">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n20">
        ...
        <node id="n18">
            <attr name="layout">
                <string>23 31 19 19</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>42 18 19 19</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
        ...
        <node id="n4">
            <attr name="layout">
                <string>43 29 19 19</string>
            </attr>
        </node>
        <node id="n19">
            <attr name="layout">
                <string>387 115 177 68</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
        ...
        <node id="n6">
            <attr name="layout">
                <string>15 26 19 19</string>
            </attr>
        </node>
        <node id="n7">
            <attr name="layout">
                <string>77 77 19 19</string>
            </attr>
        </node>
        <node id="n12">
            <attr name="layout">
                <string>86 84 19 19</string>
            </attr>
        </node>
        <node id="n21">
            <attr name="layout">
                <string>423 8 104 51</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
        ...
        <edge from="n17" to="n17">
            <attr name="label">
                <string>string:&quot;PostfixExpression&quot;</string>
            </attr>
        </edge>
        <edge from="n0" to="n0">
            <attr name="label">
