...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="host.StringLiteral">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n13">
        ...
        <node id="n10">
            <attr name="layout">
                <string>18 16 19 19</string>
            </attr>
        </node>
        <node id="n4">
            <attr name="layout">
                <string>20 23 19 19</string>
            </attr>
        </node>
        <node id="n8">
            <attr name="layout">
        ...
        <node id="n11">
            <attr name="layout">
                <string>34 33 19 19</string>
            </attr>
        </node>
        <node id="n12">
            <attr name="layout">
                <string>262 116 143 68</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
        ...
        <node id="n14">
            <attr name="layout">
                <string>282 8 104 51</string>
            </attr>
        </node>
        <node id="n6">
            <attr name="layout">
                <string>52 64 19 19</string>
            </attr>
        </node>
        <node id="n7">
            <attr name="layout">
                <string>35 58 19 19</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
                <string>474 240 143 85</string>
            </attr>
        </node>
