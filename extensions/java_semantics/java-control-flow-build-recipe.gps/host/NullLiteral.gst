...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="host.NullLiteral">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n10">
            <attr name="layout">
                <string>677 490 85 51</string>
            </attr>
        </node>
        <node id="n22">
            <attr name="layout">
        ...
        <node id="n13">
            <attr name="layout">
                <string>17 17 19 19</string>
            </attr>
        </node>
        <node id="n17">
            <attr name="layout">
                <string>728 240 129 85</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
        ...
        <node id="n23">
            <attr name="layout">
                <string>402 8 104 51</string>
            </attr>
        </node>
        <node id="n14">
            <attr name="layout">
                <string>502 240 84 85</string>
            </attr>
        </node>
        <node id="n15">
            <attr name="layout">
                <string>25 44 19 19</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
                <string>39 29 19 19</string>
            </attr>
        </node>
        <node id="n18">
            <attr name="layout">
                <string>31 33 19 19</string>
            </attr>
        </node>
        <node id="n7">
            <attr name="layout">
                <string>16 36 19 19</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
                <string>483 490 113 51</string>
            </attr>
        </node>
        <node id="n16">
            <attr name="layout">
                <string>735 382 116 34</string>
            </attr>
        </node>
        <node id="n4">
            <attr name="layout">
                <string>49 44 19 19</string>
            </attr>
        </node>
        <node id="n20">
            <attr name="layout">
                <string>389 116 129 68</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
        ...
        <node id="n12">
            <attr name="layout">
                <string>570 382 106 51</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>84 66 19 19</string>
            </attr>
        </node>
        <node id="n21">
            <attr name="layout">
                <string>68 67 19 19</string>
            </attr>
        </node>
        <node id="n0">
            <attr name="layout">
        ...
        <node id="n19">
            <attr name="layout">
                <string>37 45 19 19</string>
            </attr>
        </node>
        <node id="n6">
            <attr name="layout">
                <string>326 382 164 51</string>
            </attr>
        </node>
        ...
        <edge from="n18" to="n18">
            <attr name="label">
                <string>string:&quot;NullLiteral&quot;</string>
            </attr>
        </edge>
        <edge from="n7" to="n7">
            <attr name="label">
