...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="host.ClassLiteralAccess">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n1">
            <attr name="layout">
                <string>50 382 237 68</string>
            </attr>
        </node>
        <node id="n2">
            <attr name="layout">
        ...
        <node id="n8">
            <attr name="layout">
                <string>368 382 108 34</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
                <string>21 19 19 19</string>
            </attr>
        </node>
        <node id="n12">
            <attr name="layout">
                <string>535 382 116 34</string>
            </attr>
        </node>
        <node id="n0">
            <attr name="layout">
                <string>138 506 61 51</string>
            </attr>
        </node>
        <node id="n17">
            <attr name="layout">
                <string>315 8 104 51</string>
            </attr>
        </node>
        <node id="n15">
            <attr name="layout">
        ...
        <node id="n9">
            <attr name="layout">
                <string>226 240 84 85</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
                <string>31 65 19 19</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
                <string>67 24 19 19</string>
            </attr>
        </node>
        <node id="n6">
            <attr name="layout">
                <string>22 74 19 19</string>
            </attr>
        </node>
        <node id="n16">
            <attr name="layout">
                <string>275 116 184 68</string>
            </attr>
        </node>
        <node id="n13">
            <attr name="layout">
                <string>501 240 184 85</string>
            </attr>
        </node>
        <edge from="n1" to="n1">
            <attr name="label">
