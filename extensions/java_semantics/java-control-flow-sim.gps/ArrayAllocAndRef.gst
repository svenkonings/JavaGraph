...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="ArrayAllocAndRef">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n4">
            <attr name="layout">
                <string>651 1137 43 31</string>
            </attr>
        </node>
        <node id="n7">
            <attr name="layout">
                <string>103 344 43 31</string>
            </attr>
        </node>
        <node id="n13">
            <attr name="layout">
                <string>547 152 43 31</string>
            </attr>
        </node>
        <node id="n12">
            <attr name="layout">
                <string>429 318 99 61</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
                <string>663 950 79 46</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
                <string>565 520 151 46</string>
            </attr>
        </node>
        <node id="n17">
            <attr name="layout">
                <string>679 606 134 46</string>
            </attr>
        </node>
        <node id="n16">
            <attr name="layout">
                <string>616 793 111 46</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>40 157 170 76</string>
            </attr>
        </node>
        <node id="n14">
            <attr name="layout">
                <string>441 707 134 61</string>
            </attr>
        </node>
        <node id="n15">
            <attr name="layout">
                <string>651 1036 103 61</string>
            </attr>
        </node>
        <node id="n20">
            <attr name="layout">
                <string>635 707 72 46</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
                <string>528 606 91 61</string>
            </attr>
        </node>
        <node id="n18">
            <attr name="layout">
                <string>665 879 74 31</string>
            </attr>
        </node>
        <node id="n19">
            <attr name="layout">
                <string>574 419 73 61</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
                <string>227 318 142 46</string>
            </attr>
        </node>
        <node id="n2">
            <attr name="layout">
                <string>229 71 170 46</string>
            </attr>
        </node>
        <node id="n8">
            <attr name="layout">
                <string>311 419 203 61</string>
            </attr>
        </node>
        <node id="n6">
            <attr name="layout">
                <string>270 157 215 121</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
                <string>261 0 105 31</string>
            </attr>
        </node>
        <node id="n0">
            <attr name="layout">
                <string>68 273 114 31</string>
            </attr>
        </node>
        <edge from="n4" to="n4">
            <attr name="label">
        ...
        <edge from="n9" to="n9">
            <attr name="label">
                <string>let:dimensionLastIndex = 0</string>
            </attr>
        </edge>
        <edge from="n9" to="n17">
            <attr name="label">
        ...
        <edge from="n9" to="n10">
            ...
            <attr name="layout">
                <string>500 0 640 543 468 606 573 636 12</string>
            </attr>
        </edge>
        ...
        <edge from="n16" to="n18">
            ...
            <attr name="layout">
                <string>500 0 671 816 605 879 702 894 12</string>
            </attr>
        </edge>
        <edge from="n1" to="n1">
            <attr name="label">
        ...
        <edge from="n1" to="n1">
            <attr name="label">
                <string>let:name = &quot;ArrayAllocAndRef&quot;</string>
            </attr>
        </edge>
        <edge from="n1" to="n1">
            <attr name="label">
        ...
        <edge from="n15" to="n11">
            ...
            <attr name="layout">
                <string>500 0 702 1066 754 1137 702 973 12</string>
            </attr>
        </edge>
        ...
        <edge from="n19" to="n9">
            ...
            <attr name="layout">
                <string>500 0 610 449 505 520 640 543 12</string>
            </attr>
        </edge>
        <edge from="n5" to="n5">
            <attr name="label">
