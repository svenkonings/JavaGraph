...
import graphbuilder.AjASTVisitor;
...
public class AspectDeclaration extends TypeDeclaration {
	...
	public void traverse(AjASTVisitor visitor, BlockScope scope) {
		...
		//		super.traverse(visitor, blockScope);
		visitor.endVisit(this, scope);
	}

	public void traverse(AjASTVisitor visitor, ClassScope scope) {
		visitor.visit(this, scope);
		// TODO Auto-generated method stub
		//		super.traverse(visitor, blockScope);
		visitor.endVisit(this, scope);
