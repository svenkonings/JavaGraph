...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="start" role="graph" edgeids="false" edgemode="directed">
        ...
        <edge from="n47" to="n13">
            <attr name="label">
                <string>next</string>
            </attr>
        </edge>
        <edge from="n48" to="n23">
            <attr name="label">
        ...
        <edge from="n24" to="n42">
            <attr name="label">
                <string>name</string>
            </attr>
        </edge>
        <edge from="n13" to="n47">
            <attr name="label">
                <string>next</string>
            </attr>
        </edge>
        ...
        <edge from="n18" to="n39">
            <attr name="label">
                <string>method</string>
            </attr>
        </edge>
        <edge from="n23" to="n37">
            <attr name="label">
                <string>extends</string>
            </attr>
        </edge>
        ...
        <edge from="n39" to="n17">
            <attr name="label">
                <string>name</string>
            </attr>
        </edge>
        <edge from="n36" to="n17">
            <attr name="label">
                <string>id</string>
            </attr>
        </edge>
