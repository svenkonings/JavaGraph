...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="start-8p">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <attr name="$version">
        ...
        <node id="n7">
            <attr name="layout">
                <string>143 281 48 16</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
                <string>756 146 29 16</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
                <string>140 371 48 16</string>
            </attr>
        </node>
        <node id="n0">
            <attr name="layout">
                <string>881 146 29 16</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
                <string>694 144 29 16</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
