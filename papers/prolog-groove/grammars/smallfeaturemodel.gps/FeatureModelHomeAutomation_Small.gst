...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="FeatureModelHomeAutomation_Small">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <attr name="$version">
        ...
        <node id="n18">
            <attr name="layout">
                <string>192 79 140 46</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>395 93 171 46</string>
            </attr>
        </node>
        <node id="n6">
            <attr name="layout">
        ...
        <node id="n34">
            <attr name="layout">
                <string>226 161 179 46</string>
            </attr>
        </node>
        <node id="n19">
            <attr name="layout">
                <string>380 339 104 46</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
